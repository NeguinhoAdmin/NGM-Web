                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                <td class="logo" style="text-align: left;">
                                    <img src="https://neguinhomotors.co.uk/img/neguinhomotors3.png" alt="" style="width: 40%; max-width: 600px; height: auto; margin-bottom: 10px; display: block;">
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding: 0 2.5em; text-align: left;">
                                    <div class="text">
                                        <h2>Hi {{ ucfirst(trans($user->first_name)) }},</h2>
                                        <h3>Your rental payment is due by {{ Carbon\Carbon::now()->addDay()->format('d/m/Y') }}</h3>
                                        ...
                                        <img style="width: 40%; height: auto; margin-bottom: 10px; display: block; text-align: left;" src="https://neguinhomotors.co.uk/img/neguinhomotors3.png" alt="">
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                            <td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
                                <div class="product-entry">
                                    <img src="https://neguinhomotors.co.uk/img/neguinhomotors3.png" alt="" style="width: 100px; max-width: 600px; height: auto; margin-bottom: 20px; display: block;">
                                    <div class="text">
