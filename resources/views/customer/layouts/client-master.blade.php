        ...
        <div class="container">
            <div class="w-100 d-flex justify-content-between">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <div>
                        <a style="color: white;" class="text-light" style="padding-right: 5px;" href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();">Logout</a>
                    </div>
                </form>
                @endauth
                ...
                @guest
                <div>
                    <a style="color: white;" class="text-light" style="padding-right: 5px;" href="{{ route('login') }}" onmouseover="this.style.color='#f63440'" onMouseOut="this.style.color='#fff'">Login </a> /
                    <a style="color: white;" class="text-light" style="padding-right: 5px;" href="{{ route('register') }}" onmouseover="this.style.color='#f63440'" onMouseOut="this.style.color='#fff'">Register</a>
                </div>
                @endguest
            </div>
        </div>
