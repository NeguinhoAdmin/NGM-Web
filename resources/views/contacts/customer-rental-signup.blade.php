        ...
        <div class="row align-items-start mb-3">
            <div class="col-xs-12 col-sm-6 mb-3">
                ...
                <div class="mb-3">
                    ...
                    <h4 class="mb-3">
                        Click on the "Rent this {{ $motorcycle->make }} {{ $motorcycle->model }}" button to sign your rental agreement.
                    </h4>
                    <h4 class="mb-3">
                        Please ensure that all your required documentation has been uploaded and up to date in your NGM Customer Portal.
                    </h4>
                    <h4 class="mb-3">
                        If you have any questions regarding the rental process or need support, please call us on 0208 314 1498.
                    </h4>
                    <h4>
            ...
            <div class="col mb-3">
                ...
                <input hidden class="form-control list-group-item" type="text" name="user_id" id="user_id" value="{{ $user->id }}">
