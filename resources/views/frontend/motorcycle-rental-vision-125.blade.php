                    ...
                    <div class="inner">
                        <div class="content-detail form-group">
                            <div class="product-thumb clearfix mb-3">
                                <h2 class="product-title" value="" name="name">HONDA VISION 125</h2>
                                <div>
                                ...
                                <div class="product-info clearfix mb-3">
                                    ...
                                    <ul class="fa-ul mb-3">
                                        <li><i class="fa-li fa fa-check-square" style="color: #c31924;"></i>Driving Licence</li>
                                        <li><i class="fa-li fa fa-check-square" style="color: #c31924;"></i>Proof of Address</li>
                                        <li><i class="fa-li fa fa-check-square" style="color: #c31924;"></i>Proof of Identification</li>
                                        <li><i class="fa-li fa fa-check-square" style="color: #c31924;"></i>Insurance Certification</li>
                                ...
                                <div class="product-quantity margin-top-35 mb-3">
                                    ...
                                    <div class="price margin-top-24">
                                        <ins><span class="amount" value="" name="price" id="price">or call <a href="tel:02083141498">0208 314 1498</a></span></ins>
                                    </div>
                                </div>
                            </div>
                        </div>
