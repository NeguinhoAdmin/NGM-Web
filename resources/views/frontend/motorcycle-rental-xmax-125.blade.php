                    ...
                    <div class="inner">
                        <div class="content-detail form-group">
                            <div class="product-thumb clearfix mb-3">
                                <h2 class="product-title" value="" name="name">YAMAHA XMAX 125</h2>
                                <div>
